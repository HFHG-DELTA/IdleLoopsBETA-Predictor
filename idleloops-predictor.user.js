// ==UserScript==
// @name         IdleLoops Predictor Irontygre
// @namespace    https://github.com/irontygre/
// @downloadURL  https://raw.githubusercontent.com/irontygre/IdleLoops-Predictor/master/idleloops-predictor.user.js
// @version      2.3.2
// @description  Predicts the amount of resources spent and gained by each action in the action list. Valid as of IdleLoops v2.9/lloyd-delacroix.
...
const Koviko = {
  ...
  Predictor: class {
    ...
    initStyle() {
      ...
      ul.koviko .manaBought{color:#6371ca;width:0px;}
      ...
      ul.koviko .hide{color:#917a50;width:0px;}
      ul.koviko .potions{color:#00b2ee;width:0px;}
      ul.koviko .lpotions{color:#436ef7;width:0px;}
      ...
      ul.koviko .heroism{color:#ff0000;width:0px;}
      ul.koviko .power{color:#0000ff;width:0px;}
      ul.koviko .map{color:#2ea9bd;width:0px;}
      ul.koviko .completedMap{color:#45e5ff;width:0px;}
      ul.koviko .finLoops{color:#777777;width:0px;}
      ul.koviko .heart{color:#ca0b0b;width:0px;}
      ul.koviko .giants{color:#6ba9c4;width:0px;}
    ...
    async update(actions, container, isDebug) {
      ...
      affected.forEach(x => state.maxLength[x] || (state.maxLength[x] = 0));
